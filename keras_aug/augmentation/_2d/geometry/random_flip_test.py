...
class RandomFlipTest(tf.test.TestCase, parameterized.TestCase):
    def test_horizontal_flip(self):
        ...
        layer = augmentation.RandomFlip("horizontal")
    ...
    def test_vertical_flip(self):
        ...
        layer = augmentation.RandomFlip("vertical")
        with unittest.mock.patch.object(
            layer._random_generator,
            "random_uniform",
            return_value=mock_random,
    ...
    def test_flip_both(self):
        ...
        layer = augmentation.RandomFlip("horizontal_and_vertical")
        with unittest.mock.patch.object(
            layer._random_generator,
            "random_uniform",
            return_value=mock_random,
    ...
    def test_random_flip_low_rate(self):
        ...
        mock_random = tf.convert_to_tensor([[0.6], [0.6]])
        layer = augmentation.RandomFlip(rate=0.1)
        with unittest.mock.patch.object(
            layer._random_generator,
            "random_uniform",
            return_value=mock_random,
    ...
    def test_random_flip_high_rate(self):
        ...
        layer = augmentation.RandomFlip(rate=0.9)
        with unittest.mock.patch.object(
            layer._random_generator,
            "random_uniform",
            return_value=mock_random,
    ...
    def test_config_with_custom_name(self):
        layer = augmentation.RandomFlip(name="image_preproc")
        config = layer.get_config()
        layer_1 = augmentation.RandomFlip.from_config(config)
    ...
    def test_output_dtypes(self):
        ...
        layer = augmentation.RandomFlip(dtype="uint8")
    ...
    def test_ragged_bounding_boxes(self):
        ...
        layer = augmentation.RandomFlip(bounding_box_format="xyxy")
        _ = layer(input)
