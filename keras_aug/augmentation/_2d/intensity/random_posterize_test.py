...
class RandomPosterizeTest(tf.test.TestCase):
    ...
    def test_raises_error_on_invalid_bits_parameter(self):
        ...
        for value in invalid_values:
            with self.assertRaises(ValueError):
                augmentation.RandomPosterize(value_range=(0, 1), factor=value)
    ...
    def test_single_image(self):
        ...
        layer = augmentation.RandomPosterize(
    ...
    def test_single_image_rescaled(self):
        ...
        layer = augmentation.RandomPosterize(
            value_range=[0, 1], factor=(bits, bits)
        )
        output = layer(dummy_input)
    ...
    def _calc_expected_output(image, bits):
        """augmentation.RandomPosterize in numpy, based on Albumentations:
