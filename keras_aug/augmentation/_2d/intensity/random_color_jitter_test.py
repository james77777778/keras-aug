...
class RandomColorJitterTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_no_adjustment(self):
        ...
        layer = augmentation.RandomColorJitter(**self.no_aug_args)
        output = layer(image)
    ...
    def test_adjustment_for_non_rgb_value_range(self):
        ...
        layer = augmentation.RandomColorJitter(**self.regular_args)
        output = layer(image)
    ...
    def test_max_brightness(self):
        ...
        layer = augmentation.RandomColorJitter(**args, seed=2023)
    ...
    def test_zero_brightness(self):
        ...
        layer = augmentation.RandomColorJitter(**args)
