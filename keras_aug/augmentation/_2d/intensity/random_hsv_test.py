...
class RandomHSVTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_no_adjustment(self):
        ...
        layer = augmentation.RandomHSV(**self.no_aug_args)
        output = layer(image)
    ...
    def test_adjustment_for_non_rgb_value_range(self):
        ...
        layer = augmentation.RandomHSV(**self.regular_args)
        output = layer(image)
    ...
    def test_adjust_full_opposite_hue(self):
        ...
        layer = augmentation.RandomHSV(**args)
        output = layer(image)
    ...
    def test_adjust_to_full_saturation(self):
        ...
        layer = augmentation.RandomHSV(**args, seed=2023)
        output = layer(image)
