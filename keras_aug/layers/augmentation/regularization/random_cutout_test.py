...
class RandomCutoutTest(tf.test.TestCase):
    ...
    def test_return_shapes_single_element(self):
        ...
        layer = layers.RandomCutout(height_factor=0.5, width_factor=0.5, seed=1)
        xs = layer(xs)
    ...
    def test_random_cutout_fail_mix_bad_param_values(self):
        self.assertRaises(ValueError, lambda: self._run_test(0.5, (15.0, 30)))
