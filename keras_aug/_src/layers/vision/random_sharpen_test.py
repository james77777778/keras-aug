...
class RandomSharpenTest(testing.TestCase):
    def setUp(self):
    ...
    def test_correctness(self):
        ...
        layer = RandomSharpen((0, 1), 2.0, p=1.0)
        y = layer(x)
        ...
        backend.set_image_data_format("channels_last")
        x = np.random.uniform(0, 1, (2, 32, 32, 3)).astype("float32")
        layer = RandomSharpen((0, 1), 2.0, p=0.0)
        y = layer(x)
    ...
    def test_correctness_uint8(self):
        ...
        layer = RandomSharpen((0, 255), 2.0, p=1.0, dtype="uint8")
        y = layer(x)
    ...
    def test_config(self):
        ...
        layer = RandomSharpen((0, 255), 2.0, p=1.0)
        y = layer(x)
